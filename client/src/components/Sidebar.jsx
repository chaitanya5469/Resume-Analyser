  ...
  return (
    ...
    >
      ...
      <div className="px-2 pb-2">
        <a 
          href="https://chaitanyacheemala.netlify.app/" 
          target="_blank" 
          rel="noopener noreferrer"
          className={clsx(
            'flex items-center gap-3 py-2.5 rounded-xl text-slate-400 hover:text-white hover:bg-white/5 transition-all duration-200',
            open ? 'px-3 justify-start' : 'mx-auto w-11 justify-center px-0'
          )}
